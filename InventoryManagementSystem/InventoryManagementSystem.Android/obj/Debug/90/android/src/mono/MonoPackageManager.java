...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "InventoryManagementSystem.Android.dll" comes first in this list. */
		"InventoryManagementSystem.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"FormsViewGroup.dll",
		"Helper.dll",
		"InventoryManagementSystem.dll",
		"Newtonsoft.Json.dll",
